...
//    }
    ...
    void initUpdateOwnerForm() throws Exception {
        ...
        // Make sure that the requested Owner is searched only once by its ID value
        verify(ownerService, times(1)).findById(anyLong());
        // Make sure that no other interactions with the ownerService take place after the search
